...
class Practice_model extends CI_Model
{
  ...
  public function get_practice_info($params = array())
  {
    ...
    , GRAD_ORDER, GPA, DEGREENAMETH
    ,PRE_DATE, PRE_ROUND, PRE_CALL, CALL_PLACE, PRE_DATEROUND, PRE_CALLROUND, PRE_CALL_PLACE
    ,GET_DATE, GET_ROUND, GET_CALL, GETCALL_PLACE, REMARK_GET, PRACTICE_STATUS");

    //,TO_CHAR(PRE_DATE , 'DD MONTHYYYY', 'NLS_CALENDAR=''THAI BUDDHA'' NLS_DATE_LANGUAGE=THAI') as PRE_DATE_TH


    $this->db->from("GRADUATE_PRACTICE_65");
