    ...
    <?
            ...
            if($profile["GRAD_CONFIRM_STATUS"] == "Y" && $profile["STD_CONFIRM_STATUS"] == "Y"){
                ...
                $text_caption = "ยืนยันการเข้ารับพระราชทานปริญญาบัตรประจำปี 2563 – 2564";
            }

            if($profile["GRAD_CONFIRM_STATUS"] == "" && $profile["STD_CONFIRM_STATUS"] == "Y"){
                $icon_class = "kt-iconbox--warning";
                $text_class = "text-warning";
                $text_caption = "ติดต่อรายงานตัวที่ กองพัฒนานักศึกษา อาคาร 2 ชั้น 3  โทร 02-2445190-1";
            }
            ...
            if(($profile["GRAD_CONFIRM_STATUS"] == "N") || ($profile["STD_CONFIRM_STATUS"] == "N")){
                ...
                $text_caption = "ไม่เข้ารับพระราชทานปริญญาบัตรประจำปี 2563 – 2564";
            }
            */
            if($profile["STD_CONFIRM_STATUS"] == "Y"){
                $icon_class = "kt-iconbox--success";
                $text_class = "text-success";
                $text_caption = "ยืนยันการเข้ารับพระราชทานปริญญาบัตรประจำปี 2563 – 2564";
            }

            if($profile["STD_CONFIRM_STATUS"] == "N"){
