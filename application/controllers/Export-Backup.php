...
class Export extends MY_Controller
{
    ...
    function id($encrypt_id){
        ...
        if($practice_result['STD_CODE']<>null){
                ...
                $pdf->Image($source_path.'uploads/'.$request_result['ID_PHOTO'], 170, 20, 30, 40, 'JPG', '', '', false, 300, '', false, false, 0, false, false, false);
                ...
                $pdf->write2DBarcode($qrCodeData, 'QRCODE,L', 125, 20, 40, 40, $style, 'N');

                $pdf->SetXY(35,28);
                $pdf->SetFont('thsarabun', '', 24);
                $pdf->Cell(0, 0, 'บัตรแสดงตัวบัณฑิต ซ้อมย่อย/ซ้อมใหญ่', 0, 1, 'L', 0, '', 0);

                $pdf->SetXY(35,35);
                $pdf->Cell(0, 0, 'การซ้อมรับพระราชทานปริญญาบัตร', 0, 1, 'L', 0, '', 0);

                $pdf->SetXY(35,42);
                $pdf->Cell(0, 0, 'ประจำปี 2567', 0, 1, 'L', 0, '', 0);
